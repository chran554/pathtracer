...
For the image below I have intentionally chosen this "tricky" scene, for pathtracing, with a very "small" light in the ceiling as it would produce a lot of noise in the image when using small amount of rays that would miss the light.
