...
func setCornellBoxMaterial(cornellBox *scn.FacetStructure) {
	...
	backWallMaterial := scn.NewMaterial().N("back").PP("textures/wallpaper/chinese_dragon.png", &vec3.T{0, 0, 0}, vec3.UnitX.Scaled(scale), vec3.UnitY.Scaled(scale))
	...
	sideWallMaterial := scn.NewMaterial().N("wall").PP("textures/wallpaper/chinese_dragon.png", &vec3.T{0, 0, 0}, vec3.UnitZ.Scaled(scale), vec3.UnitY.Scaled(scale))
	...
	floorMaterial := scn.NewMaterial().N("floor").
		...
		PP("textures/floor/floor_boards.png", &vec3.T{0, 0, 0}, vec3.UnitX.Scaled(scale), vec3.UnitZ.Scaled(scale))
