...
==== Inconsistencies within this text

If you find any ambiguities, or at least almost but not exactly the same value for a property, it is because I have extracted the information from several sources, and they all differ at some values. After all, not every one agree on the perfect notion thresholds or the even the perfect brilliant cut proportions, even if they come close. The beauty is still subjective and in the eye of the beholder.
